...
interface ITournamentInformationCreatorService {
     ...
     */
    fun create(titleCandidate: String, alternativeTitles: Map<TournamentType, String>, description: String, tournamentType: TournamentType, seedType: SeedType, rankConfig: IRankConfig): TournamentInformation
}