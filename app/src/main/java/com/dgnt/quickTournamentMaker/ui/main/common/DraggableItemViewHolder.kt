...
class DraggableItemViewHolder(private val context: Context, private val binding: DraggableListItemBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    fun onItemSelected() = itemView.setBackgroundColor(ResourcesCompat.getColor(context.resources, com.dgnt.quickTournamentMaker.R.color.dragHighlightColor, null))
