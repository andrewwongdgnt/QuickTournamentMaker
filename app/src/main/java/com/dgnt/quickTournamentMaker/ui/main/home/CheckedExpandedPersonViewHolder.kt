...
class CheckedExpandedPersonViewHolder(private val binding: PersonItemBinding, private val clickListener: (String) -> Unit) : CheckableChildViewHolder(binding.root) {
