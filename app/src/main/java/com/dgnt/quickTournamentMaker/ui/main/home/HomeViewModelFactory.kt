...
class HomeViewModelFactory(private val personRepository: IPersonRepository, private val groupRepository: IGroupRepository, private val preferenceService: IPreferenceService, private val tournamentInformationCreatorService: ITournamentInformationCreatorService, private val selectedPersonsService: ISelectedPersonsService) : ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(HomeViewModel::class.java)) {
            return HomeViewModel(personRepository, groupRepository, preferenceService, tournamentInformationCreatorService, selectedPersonsService) as T
        }
