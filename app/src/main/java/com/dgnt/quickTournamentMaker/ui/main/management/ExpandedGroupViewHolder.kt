...
class ExpandedGroupViewHolder(private val binding: GroupItemBinding, private val selectedGroups: Set<Group>, private val setDrawable: (CheckedTextView, Boolean) -> Unit, private val clickListener: (Checkable, Group, ManagementFragment.GroupEditType) -> Unit) : GroupViewHolder(binding.root) {
