...
class GroupExpandableRecyclerViewAdapter(private val actionModeCallback: ManagementFragmentActionModeCallBack, private val selectedPersons: MutableSet<String>, personGroups: List<ExpandableGroup<*>>, private val clickListener: (Person) -> Unit) : ExpandableRecyclerViewAdapter<GroupViewHolder, PersonViewHolder>(personGroups) {
